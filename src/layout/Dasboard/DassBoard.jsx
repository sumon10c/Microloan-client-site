...
const DassBoard = () => {
  ...
  <div className="drawer-content">
    ...
    <nav className="navbar w-full bg-base-300">
      ...
      <div className="px-4b">My Loans Dash-Board</div>
    </nav>
    {/* Page content here */}
    <Outlet></Outlet>
    ...
    <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
      ...
      <ul className="menu w-full grow">
        ...
        <Link to='/'>  <button className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Homepage">
         ...
         <li className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="My Loans">
         <Link to='/dassBoard/myLoans'> 
         <FaHandsHelping />
